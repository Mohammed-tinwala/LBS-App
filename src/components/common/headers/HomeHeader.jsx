...
const HomeHeader = ({ name = "Rohan Sharma" }) => {
    return (
        <div className="flex-between">
            ...
            <button className="relative w-12 h-12 rounded-full bg-white border border-gray-400 flex-center">
                <Bell size={24} />
                <span className="absolute -top-1 -right-1 w-5 h-5 text-[12px] text-white bg-red-500 rounded-full">2</span>
            </button>
